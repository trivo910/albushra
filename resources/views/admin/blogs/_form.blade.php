    ...
    <div class="form-section">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="focus-keyword-input" name="focus_keyword"
                   value="{{ old('focus_keyword', $blog->focus_keyword) }}" class="field-input">
            <p class="field-hint">The main phrase this post should rank for. Drives the analysis below.</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
...
@push('scripts')
    ...
    (function () {
        ...
        async function runAnalysis() {
            ...
            try {
                const response = await window.axios.post('{{ route('admin.blogs.seo-preview') }}', payload, {
                    headers: {
