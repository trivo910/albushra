    ...
    <div class="form-section">
        ...
        <div class="mt-4">
            ...
            @if ($page->featured_image)
                <img src="{{ \Illuminate\Support\Facades\Storage::url($page->featured_image) }}" alt="{{ $page->featured_image_alt }}"
            ...
            <div class="mt-3">
                ...
                <input type="text" name="featured_image_alt" value="{{ old('featured_image_alt', $page->featured_image_alt) }}" class="field-input">
